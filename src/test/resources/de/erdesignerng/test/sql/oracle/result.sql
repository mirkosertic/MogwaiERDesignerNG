...
CREATE VIEW VIEW1 AS SELECT "TB2_1","TB2_2","TB2_3" from Table1;
ALTER TABLE TABLE1 ADD CONSTRAINT FK1 FOREIGN KEY (TB2_1) REFERENCES TABLE2(TB3_1) ON DELETE RESTRICT;
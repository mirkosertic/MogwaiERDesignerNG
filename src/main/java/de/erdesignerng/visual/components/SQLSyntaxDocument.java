...
class SQLSyntaxDocument extends DefaultStyledDocument {
    ...
    public final String[] SQLKEYWORDS = {"ABORT", "ACCESS", "ACCESSIBLE", "ACL",
		...
		"BREAK", "BROWSE", "BULK", "BY", "CALL", "CASCADE", "CHANGE", "CHAR",
		"CHAR_CONVERT", "CHARACTER", "CHECK", "CHECKPOINT", "CLOB", "CLOSE",
		...
		"MAXEXTENTS", "MEDIUMBLOB", "MEDIUMINT", "MEDIUMTEXT", "MERGE",
		"MIDDLEINT", "MINUS", "MINUTE_MICROSECOND", "MINUTE_SECOND", "MIRROR",
		"MIRROREXIT", "MOD", "MODE", "MODIFIES", "MODIFY", "NAME", "NCHAR",
		"NCLOB", "NEW", "NEXT", "NO_WRITE_TO_BINLOG", "NOAUDIT", "NOCOMPRESS",
		...
		"RESERVED_PGS", "RETRIEVE", "RETURN", "RETURNING", "RETURNS", "RLIKE",
		...
		"SQL_CALC_FOUND_ROWS", "SQL_SMALL_RESULT", "SQLEXCEPTION", "SSL",

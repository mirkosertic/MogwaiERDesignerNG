...
public final class SQLSyntaxDocument extends DefaultStyledDocument {
	...
	public final String[] SQLKEYWORDS = {"ABORT", "ACCESS", "ACCESSIBLE", "ACL", "ACTION",
			...
			"ASENSITIVE", "AUDIT", "AUTHID", "AVG_ROW_LENGTH", "BACKWARD", "BEFORE", "BEGIN",
			"BETWEEN", "BFILE", "BIGINT", "BINARY", "BLOB", "BODY", "BOOLEAN",
			"BREAK", "BROWSE", "BULK", "BY", "CACHE", "CALL", "CASCADE", "CHANGE", "CHAR",
			"CHAR_CONVERT", "CHARACTER", "VARYING", "CHECK", "CHECKPOINT", "CHECKSUM", "CLOB", "CLOSE",
			...
			"DECLARE", "DEFAULT", "DEFERRED", "DEFFERABLE", "DELAYED", "DELAY_KEY_WRITE", "DELETE",
			"DELIMITER", "DELIMITERS", "DETERMINISTIC", "DISK", "DISTINCTROW",
			"DIV", "DO", "DOMAIN", "DOUBLE", "DROP", "DUAL", "DUMMY", "DUMP", "EACH", "ELSE",
			"ELSEIF", "ELSIF", "ENCLOSED", "END", "ENDTRAN", "ENGINE", "ENUM", "ERRLVL", "ERRORDATA",
			...
			"LONGBLOB", "LONGTEXT", "LOOP", "LOW_PRIORITY", "MAX_ROWS", "MAX_ROWS_PER_PAGE",
			"MAXEXTENTS", "MAXVALUE", "MEDIUMBLOB", "MEDIUMINT", "MEDIUMTEXT", "MERGE",
			"MIDDLEINT", "MINUS", "MIN_ROWS", "MINUTE_MICROSECOND", "MINUTE_SECOND", "MINVALUE", "MIRROR",
			...
			"OUTER", "OUTFILE", "OVER", "PACK_KEYS", "PACKAGE", "PARTITION", "PCTFREE", "PERM",

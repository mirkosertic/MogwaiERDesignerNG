...
public class SubjectAreaEditorView extends JPanel {
	...
	public class MyMouseListener extends MouseAdapter {
		...
		public void mouseClicked(final MouseEvent e) {
			final Color theColor = JColorChooser.showDialog(SubjectAreaEditorView.this, ResourceHelper.getResourceHelper(
	...
	private void initialize() {
		...
		final String rowDef = "2dlu,p,2dlu,p,2dlu,fill:p,20dlu,p,2dlu";

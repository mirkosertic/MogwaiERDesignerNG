 ...
 * @version $Date: 2008-03-09 18:20:25 $
 */
public class SubjectAreaEditorView extends JPanel {
    ...
    public class MyMouseListener extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            JColorChooser theChooser = new JColorChooser(colorPanel.getBackground());
            Color theColor = theChooser.showDialog(SubjectAreaEditorView.this, ResourceHelper.getResourceHelper(

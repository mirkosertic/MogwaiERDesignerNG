...
public class ReverseEngineerView extends JPanel {
	...
	public JPanel getschemagrid() {
		...
		if (m_schemagrid == null) {
			...
			m_schemagrid.add(new JScrollPane(this.getschemaList()), cons.xywh(
					1, 2, 3, 1));
	...
	public JPanel getengineeringoptions() {
		...
		if (m_engineeringoptions == null) {
			...
			m_engineeringoptions.add(this.getComponent_9(), cons.xywh(1, 2, 1,
					1));
			m_engineeringoptions.add(this.getComponent_10(), cons.xywh(1, 4, 1,
					1));
			m_engineeringoptions.add(this.getComponent_11(), cons.xywh(1, 6, 1,
					1));
			m_engineeringoptions.add(this.getNaming(), cons.xywh(3, 2, 1, 1));
			m_engineeringoptions.add(this.getDomaingeneration(), cons.xywh(3,
					4, 1, 1));
			m_engineeringoptions.add(this.getDefaultvaluegeneration(), cons
					.xywh(3, 6, 1, 1));
	...
	public javax.swing.JLabel getComponent_11() {
		...
		if (m_component_11 == null) {
			m_component_11 = new DefaultLabel(
					ERDesignerBundle.DEFAULTVALUEENERATION);
		}

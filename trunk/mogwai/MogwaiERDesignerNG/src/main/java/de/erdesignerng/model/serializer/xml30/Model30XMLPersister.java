...
/**
 * Persister for model version 3.0.
 * 
 * @author dr-death
 */
public class Model30XMLPersister implements CommonXMLElementsAndAttributes {
    ...
    public Model30XMLPersister(ModelIOUtilities aUtils) {
        utils = aUtils;
    }

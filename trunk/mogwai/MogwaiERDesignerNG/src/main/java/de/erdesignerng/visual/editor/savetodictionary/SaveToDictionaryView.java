 ...
 * @author msertic
 */
public class SaveToDictionaryView extends JPanel {
    ...
    private void initialize() {
        ...
        String theRowDef = "2dlu,p,2dlu,p,2dlu,p,2dlu,p,50dlu,2dlu,p,2dlu";

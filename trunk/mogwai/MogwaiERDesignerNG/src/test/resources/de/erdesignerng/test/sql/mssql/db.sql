...
create table Table_2 (tb2_1 varchar(20) not null,tb2_2 varchar(100) default 'Test',tb2_3 decimal(20,5) not null)
alter table Table_2 add constraint PK3 primary key (tb2_1)
create table Tablea2 (tb3_1 varchar(20) not null,tb3_2 varchar(100) default 'Test',tb3_3 decimal(20,5) not null,CONSTRAINT PK6 PRIMARY KEY (tb3_1))
alter table Tablea2 add constraint PK8 primary key (tb3_1)
